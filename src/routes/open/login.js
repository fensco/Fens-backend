...
const _ = require("lodash"); //It helps in javascript management by providing simplified way o getting all string manipulation functions, methods and properties
